...
### Description
A simple CLI-based number guessing game where the user is asked to guess a number that was randomised by the computer within a limited number of chances. The game continues until the user has correctly guessed the random number or has run out of allowed chances.

This is an exercise retrieved from roadmap.sh ([https://roadmap.sh/projects/number-guessing-game](https://roadmap.sh/projects/number-guessing-game)).
